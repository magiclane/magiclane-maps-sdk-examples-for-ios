...
class ViewController: UIViewController, MapViewControllerDelegate, NavigationContextDelegate {
    ...
    func addResetFollowPreferencesButton() {
        ...
        button.translatesAutoresizingMaskIntoConstraints = false
        let constraintRight = NSLayoutConstraint( item: button, attribute: NSLayoutConstraint.Attribute.trailing,
                                                  relatedBy: NSLayoutConstraint.Relation.equal,
                                                  toItem: self.view, attribute: NSLayoutConstraint.Attribute.trailing,
                                                  multiplier: 1.0, constant: -10)
    ...
    @objc func resetFollowPositionPreferencesButtonAction() {
        ...
        mapViewController.restoreFollowingPosition(withAnimationDuration: 200, completionHandler: { success in
    ...
    func mapViewController(_ mapViewController: MapViewController, onShove pointersAngleDeg: Double, initial: CGPoint, start: CGPoint, end: CGPoint) {
