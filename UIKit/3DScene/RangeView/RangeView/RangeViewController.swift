...
class RangeViewController: UIViewController {
    ...
    func areaEdge(top: CGFloat, left: CGFloat, bottom: CGFloat, right: CGFloat) -> UIEdgeInsets {
        ...
        let insets = UIEdgeInsets.init(
            top: (self.view.safeAreaInsets.top + top) * scale,
            left: left * scale,
    ...
    func presentOptionsMenu(title: String, options: [String], selectedIndex: Int, completion: @escaping (_ newIndex: Int) -> Void)
        -> UIAlertController?
    {
