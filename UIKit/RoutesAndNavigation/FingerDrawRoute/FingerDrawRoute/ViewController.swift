...
class ViewController: UIViewController {
    ...
    func createTitleViewButton() -> UIButton {
        ...
        let typeBike = UIAction(
            title: "Bike", image: UIImage.init(systemName: "bicycle", withConfiguration: configuration),
            state: .off,
        ...
        let typePedestrian = UIAction(
            title: "Pedestrian", image: UIImage.init(systemName: "figure.walk", withConfiguration: configuration),
            state: .off,
            handler: { [weak self] action in
