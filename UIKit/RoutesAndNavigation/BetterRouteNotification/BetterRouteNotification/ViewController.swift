...
class ViewController: UIViewController, MapViewControllerDelegate, NavigationContextDelegate {
    ...
    func addMyPositionButton() {
        ...
        NSLayoutConstraint.activate([
            ...
            button.bottomAnchor.constraint(equalTo: self.view.safeAreaLayoutGuide.bottomAnchor, constant: -15),
    ...
    func addLabelText() {
        ...
        NSLayoutConstraint.activate([
            self.label.leadingAnchor.constraint(equalTo: self.myPositionButton!.trailingAnchor, constant: 10),
            ...
            self.label.heightAnchor.constraint(equalToConstant: 60)
        ])
    }
    ...
    func presentBetterRouteButton() {
        ...
        if let image = UIImage.init(
            systemName: "point.topleft.down.curvedto.point.bottomright.up", withConfiguration: UIImage.SymbolConfiguration(pointSize: 20))
        {
