...
class ViewController: UIViewController, MapViewControllerDelegate {
    ...
    func createMapView() {
        ...
        let constraintTop = NSLayoutConstraint(
            item: self.mapViewController!.view!, attribute: NSLayoutConstraint.Attribute.top,
            relatedBy: NSLayoutConstraint.Relation.equal,
            toItem: self.view, attribute: NSLayoutConstraint.Attribute.top,
            multiplier: 1.0, constant: 0)

        let constraintLeft = NSLayoutConstraint(
            item: self.mapViewController!.view!, attribute: NSLayoutConstraint.Attribute.leading,
            relatedBy: NSLayoutConstraint.Relation.equal,
            toItem: self.view, attribute: NSLayoutConstraint.Attribute.leading,
            multiplier: 1.0, constant: 0)

        let constraintBottom = NSLayoutConstraint(
            item: self.mapViewController!.view!, attribute: NSLayoutConstraint.Attribute.bottom,
            relatedBy: NSLayoutConstraint.Relation.equal,
            toItem: self.view, attribute: NSLayoutConstraint.Attribute.bottom,
            multiplier: 1.0, constant: -0)

        let constraintRight = NSLayoutConstraint(
            item: self.mapViewController!.view!, attribute: NSLayoutConstraint.Attribute.trailing,
            relatedBy: NSLayoutConstraint.Relation.equal,
    ...
    func addLabelText() {
        ...
        var constraintLeft = NSLayoutConstraint(
            item: self.label, attribute: NSLayoutConstraint.Attribute.leading,
            relatedBy: NSLayoutConstraint.Relation.equal,
            toItem: self.view, attribute: NSLayoutConstraint.Attribute.leading,
            multiplier: 1.0, constant: 10.0)

        let constraintBottom = NSLayoutConstraint(
            item: self.label, attribute: NSLayoutConstraint.Attribute.bottom,
            relatedBy: NSLayoutConstraint.Relation.equal,
            toItem: self.view.safeAreaLayoutGuide, attribute: NSLayoutConstraint.Attribute.bottom,
            multiplier: 1.0, constant: -10.0)

        let constraintRight = NSLayoutConstraint(
            item: self.label, attribute: NSLayoutConstraint.Attribute.trailing,
            relatedBy: NSLayoutConstraint.Relation.equal,
            toItem: self.view, attribute: NSLayoutConstraint.Attribute.trailing,
            multiplier: 1.0, constant: -10.0)

        var constraintHeight = NSLayoutConstraint(
            item: self.label, attribute: NSLayoutConstraint.Attribute.height,
            relatedBy: NSLayoutConstraint.Relation.equal,
        ...
        constraintLeft = NSLayoutConstraint(
            item: self.imageView, attribute: NSLayoutConstraint.Attribute.leading,
            relatedBy: NSLayoutConstraint.Relation.equal,
            toItem: self.label, attribute: NSLayoutConstraint.Attribute.leading,
            multiplier: 1.0, constant: 0.0)

        let constraintTop = NSLayoutConstraint(
            item: self.imageView, attribute: NSLayoutConstraint.Attribute.top,
            relatedBy: NSLayoutConstraint.Relation.equal,
            toItem: self.label, attribute: NSLayoutConstraint.Attribute.top,
            multiplier: 1.0, constant: -20.0)

        let constraintWidth = NSLayoutConstraint(
            item: self.imageView, attribute: NSLayoutConstraint.Attribute.width,
            relatedBy: NSLayoutConstraint.Relation.equal,
            toItem: nil, attribute: NSLayoutConstraint.Attribute.notAnAttribute,
            multiplier: 1.0, constant: 40.0)

        constraintHeight = NSLayoutConstraint(
            item: self.imageView, attribute: NSLayoutConstraint.Attribute.height,
            relatedBy: NSLayoutConstraint.Relation.equal,
            toItem: nil, attribute: NSLayoutConstraint.Attribute.notAnAttribute,
            multiplier: 1.0, constant: 40.0)
    ...
    @objc func currentWeatherButtonPressed() {
        ...
        _ = WeatherContext.shared()
            .requestCurrentForecast([coordinates]) { [weak self] error, results in
    ...
    func createCurrentWeatherView(_ forecast: WeatherContextForecast) {
        ...
        for parameter in forecast.conditions.parameters {
            ...
            if parameter.type == "FeelsLike" {
                ...
                model.feelsLikeTemp = parameter.name + " " + String(format: "%1.f", round(parameter.value)) + parameter.unit
            }

            if parameter.type == "AirQuality" {

                let item = WeatherCurrentParameterItem(
                    name: parameter.name,
                    value: String(format: "%1.f", round(parameter.value))
                )
            ...
            if parameter.type == "DewPoint" {
                ...
                let item = WeatherCurrentParameterItem(
                    name: parameter.name,
                    value: String(format: "%1.f", round(parameter.value)) + parameter.unit
                )
            ...
            if parameter.type == "Sunrise" {
                ...
                let item = WeatherCurrentParameterItem(
                    name: parameter.name,
                    value: getLocalShortTimeFor(time: parameter.value)
                )
            ...
            if parameter.type == "Visibility" {
                ...
                let item = WeatherCurrentParameterItem(
                    name: parameter.name,
                    value: String(format: "%.2f", parameter.value) + " " + parameter.unit
                )
    ...
    @objc func hourlyWeatherButtonPressed() {
        ...
        _ = WeatherContext.shared()
            .requestHourlyForecast([coordinates], hours: 24) { [weak self] error, results in
    ...
    @objc func dailyWeatherButtonPressed() {
        ...
        _ = WeatherContext.shared()
            .requestDailyForecast([coordinates], days: 10) { [weak self] error, results in
    ...
    func getTimeZoneFor(coordinates: CoordinatesObject) -> TimeZone {
        ...
        if status == .success {
            ...
            if !timeZoneId.isEmpty, let value = TimeZone(identifier: timeZoneId) {
